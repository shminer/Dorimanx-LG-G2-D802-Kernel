	...
	struct msm_camera_v4l2_ioctl_t *ioctl_ptr)
{
	...
	struct msm_buf_mngr_info buff_mgr_info;
#else
	/*LGE_CHANGES, fixed 60fps recording issue, 2013-11-01, jonghwan.ko@lge.com */
...
#else
	/*LGE_CHANGES_S, fixed 60fps recording issue, 2013-11-01, jonghwan.ko@lge.com */
	/* get buffer for duplicate output */
	if (new_frame->duplicate_output) {
		CPP_DBG("duplication enabled, dup_id=0x%x",
			new_frame->duplicate_identity);
	...
	/*LGE_CHANGES_E, fixed 60fps recording issue, 2013-11-01, jonghwan.ko@lge.com */
#endif
