...
static struct msm_bus_paths bw_level_tbl[] __initdata = {
	...
	[9] = BW_MBPS(8528), /* At least 1066 MHz on bus. */
};
...
static struct l2_level l2_freq_tbl[] __initdata = {
	...
	[19] = { { 1728000, HFPLL, 1,  90 }, LVL_HIGH, 1050000, 9 },
	[20] = { { 1881000, HFPLL, 1,  98 }, LVL_HIGH, 1050000, 9 },
	{ }
};
...
static struct acpu_level acpu_freq_tbl_2p3g_pvs0[] __initdata = {
	...
	{ 0, { 1804800, HFPLL, 1,  94 }, L2(18), 1010000, 510 },
	{ 0, { 1881600, HFPLL, 1,  98 }, L2(18), 1025000, 538 },
	{ 1, { 1958400, HFPLL, 1, 102 }, L2(20), 1040000, 565 },
	{ 0, { 2035200, HFPLL, 1, 106 }, L2(20), 1055000, 596 },
	{ 0, { 2112000, HFPLL, 1, 110 }, L2(20), 1070000, 627 },
	...
	{ 1, { 2726400, HFPLL, 1, 142 }, L2(20), 1190000, 900 },
	{ 1, { 2803200, HFPLL, 1, 146 }, L2(20), 1200000, 937 },
#endif
#endif	
	{ 0, { 0 } }
};
...
static struct acpu_level acpu_freq_tbl_2p3g_pvs1[] __initdata = {
	...
	{ 0, { 1804800, HFPLL, 1,  94 }, L2(18),  990000, 510 },
	{ 0, { 1881600, HFPLL, 1,  98 }, L2(18), 1005000, 538 },
	{ 1, { 1958400, HFPLL, 1, 102 }, L2(20), 1020000, 565 },
	{ 0, { 2035200, HFPLL, 1, 106 }, L2(20), 1030000, 596 },
	{ 0, { 2112000, HFPLL, 1, 110 }, L2(20), 1045000, 627 },
...
#ifdef CONFIG_OC_ULTIMATE
	{ 1, { 2726400, HFPLL, 1, 142 }, L2(20), 1165000, 900 },
	{ 1, { 2803200, HFPLL, 1, 146 }, L2(20), 1180000, 937 },
#endif
#endif	
	{ 0, { 0 } }
};
...
static struct acpu_level acpu_freq_tbl_2p3g_pvs2[] __initdata = {
	...
	{ 0, { 1804800, HFPLL, 1,  94 }, L2(18),  970000, 510 },
	{ 0, { 1881600, HFPLL, 1,  98 }, L2(18),  980000, 538 },
	{ 1, { 1958400, HFPLL, 1, 102 }, L2(20),  995000, 565 },
	{ 0, { 2035200, HFPLL, 1, 106 }, L2(20), 1005000, 596 },
	{ 0, { 2112000, HFPLL, 1, 110 }, L2(20), 1020000, 627 },
...
#ifdef CONFIG_OC_ULTIMATE
	{ 1, { 2726400, HFPLL, 1, 142 }, L2(20), 1140000, 900 },
	{ 1, { 2803200, HFPLL, 1, 146 }, L2(20), 1155000, 937 },
#endif
#endif	
	{ 0, { 0 } }
};
...
static struct acpu_level acpu_freq_tbl_2p3g_pvs3[] __initdata = {
	...
	{ 0, { 1804800, HFPLL, 1,  94 }, L2(18),  950000, 510 },
	{ 0, { 1881600, HFPLL, 1,  98 }, L2(18),  960000, 538 },
	{ 1, { 1958400, HFPLL, 1, 102 }, L2(20),  970000, 565 },
	{ 0, { 2035200, HFPLL, 1, 106 }, L2(20),  985000, 596 },
	{ 0, { 2112000, HFPLL, 1, 110 }, L2(20),  995000, 627 },
...
#ifdef CONFIG_OC_ULTIMATE
	{ 1, { 2726400, HFPLL, 1, 142 }, L2(20), 1115000, 900 },
	{ 1, { 2803200, HFPLL, 1, 146 }, L2(20), 1130000, 937 },
#endif
#endif	
	{ 0, { 0 } }
};
...
static struct acpu_level acpu_freq_tbl_2p3g_pvs4[] __initdata = {
	...
	{ 0, { 1804800, HFPLL, 1,  94 }, L2(18),  930000, 510 },
	{ 0, { 1881600, HFPLL, 1,  98 }, L2(18),  940000, 538 },
	{ 1, { 1958400, HFPLL, 1, 102 }, L2(20),  950000, 565 },
	{ 0, { 2035200, HFPLL, 1, 106 }, L2(20),  960000, 596 },
	{ 0, { 2112000, HFPLL, 1, 110 }, L2(20),  975000, 627 },
...
#ifdef CONFIG_OC_ULTIMATE
	{ 1, { 2726400, HFPLL, 1, 142 }, L2(20), 1090000, 900 },
	{ 1, { 2803200, HFPLL, 1, 146 }, L2(20), 1115000, 937 },
#endif
#endif	
	{ 0, { 0 } }
};
...
static struct acpu_level acpu_freq_tbl_2p3g_pvs5[] __initdata = {
	...
	{ 0, { 1804800, HFPLL, 1,  94 }, L2(18),  910000, 510 },
	{ 0, { 1881600, HFPLL, 1,  98 }, L2(18),  920000, 538 },
	{ 1, { 1958400, HFPLL, 1, 102 }, L2(20),  930000, 565 },
	{ 0, { 2035200, HFPLL, 1, 106 }, L2(20),  940000, 596 },
	{ 0, { 2112000, HFPLL, 1, 110 }, L2(20),  955000, 627 },
...
#ifdef CONFIG_OC_ULTIMATE
	{ 1, { 2726400, HFPLL, 1, 142 }, L2(20), 1065000, 900 },
	{ 1, { 2803200, HFPLL, 1, 146 }, L2(20), 1080000, 937 },
#endif
#endif	
	{ 0, { 0 } }
};
...
static struct acpu_level acpu_freq_tbl_2p3g_pvs6[] __initdata = {
	...
	{ 0, { 1804800, HFPLL, 1,  94 }, L2(18),  895000, 510 },
	{ 0, { 1881600, HFPLL, 1,  98 }, L2(18),  905000, 538 },
	{ 1, { 1958400, HFPLL, 1, 102 }, L2(20),  915000, 565 },
	{ 0, { 2035200, HFPLL, 1, 106 }, L2(20),  920000, 596 },
	{ 0, { 2112000, HFPLL, 1, 110 }, L2(20),  930000, 627 },
...
#ifdef CONFIG_OC_ULTIMATE
	{ 1, { 2726400, HFPLL, 1, 142 }, L2(20), 1040000, 900 },
	{ 1, { 2803200, HFPLL, 1, 146 }, L2(20), 1055000, 937 },
#endif
#endif	
	{ 0, { 0 } }
};
